        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-white leading-tight">
              {t('about.title_1')} <span className="text-primary-600 dark:text-primary-400">{t('about.title_2')}</span>{t('about.title_3')}{' '}
              <span className="text-primary-600 dark:text-primary-400">{t('about.title_4')}</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t('about.vision_title')}</h3>
            ...
            <div className="p-8 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t('about.mission_title')}</h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="p-6 flex-grow flex flex-col justify-center text-center border-t border-gray-100 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{t('about.trade_title')}</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">{t('about.trade_desc')}</p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="p-6 flex-grow flex flex-col justify-center text-center border-t border-gray-100 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{t('about.drug_title')}</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">{t('about.drug_desc')}</p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="p-6 flex-grow flex flex-col justify-center text-center border-t border-gray-100 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{t('about.pcb_title')}</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">{t('about.pcb_desc')}</p>
              </div>
            </div>
          </div>
        </div>
