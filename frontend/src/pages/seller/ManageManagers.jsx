...
import { Plus, Trash2, X, Mail, Lock, UserCircle } from 'lucide-react';
import { useData } from '../../contexts/DataContext';

function ManageManagers() {
    const { users, addUser, deleteUser, branches } = useData();
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden">
                        <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-slate-800">
                            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Create New Manager</h3>
